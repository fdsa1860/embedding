% Function that only test the classification accuracy for SDE manifold.
% By Fei Xiong
%    ECE Dept.,
...
function [validation_fold,test_fold,SDEStruct,error_rate_SDE] = test_SDE_test_only(name_data,dim_thresh,method, mode , varargin)
num_test_fold=[];
if size(varargin)>0
